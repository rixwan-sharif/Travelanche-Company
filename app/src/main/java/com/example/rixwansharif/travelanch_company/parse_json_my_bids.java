 ...
 */
public class parse_json_my_bids {
    ...
    public static String[] bid_date;
    public static String[] bid_time;

    private JSONArray my_bids = null;

    private String json;

    public parse_json_my_bids(String json)
    {
        this.json = json;
    }
...

    {
        ...
        try
        {
            ...
            my_bids = jsonObject.getJSONArray("my_bids");

            id = new String[my_bids.length()];
            trip_destination =new String[my_bids.length()];
            trip_pickup_location = new String[my_bids.length()];
            trip_vehicle=new String[my_bids.length()];
            trip_start_date=new String[my_bids.length()];
            trip_end_date = new String[my_bids.length()];
            trip_pick_time =new String[my_bids.length()];
            trip_drop_time =new String[my_bids.length()];
            trip_driver = new String[my_bids.length()];
            trip_ac=new String[my_bids.length()];
            trip_date = new String[my_bids.length()];
            trip_time=new String[my_bids.length()];
            trip_id = new String[my_bids.length()];
            trip_client_phone=new String[my_bids.length()];

            bid_date=new String[my_bids.length()];
            bid_time=new String[my_bids.length()];
            bid_rate_per_day = new String[my_bids.length()];
            bid_total_fare =new String[my_bids.length()];
            bid_vehicle =new String[my_bids.length()];
            bid_vehicle_img = new String[my_bids.length()];
            bids_on_trip=new String[my_bids.length()];

            for (int i = 0; i < my_bids.length(); i++)
            {
                JSONObject jo = my_bids.getJSONObject(i);
                ...
                bid_date[i] = jo.getString("bid_date");
                bid_time[i] = jo.getString("bid_time");
