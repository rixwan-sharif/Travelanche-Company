...
public class MyAcceptedBidsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Accepted Bids");
    ...
    private void showJSON(String json){
        ...
        custom_row_for_my_accepted_bid cr=new custom_row_for_my_accepted_bid(this, parse_json_my_accepted_bids.id, parse_json_my_accepted_bids.trip_destination, parse_json_my_accepted_bids.trip_pickup_location,
                ...
                parse_json_my_accepted_bids.bid_accept_date,parse_json_my_accepted_bids.bid_accept_time,parse_json_my_accepted_bids.bid_rate_per_day,
                ...
                parse_json_my_accepted_bids.trip_date,parse_json_my_accepted_bids.trip_time);
    ...
    public class custom_row_for_my_accepted_bid extends ArrayAdapter<String> {
        ...
        public custom_row_for_my_accepted_bid(Activity context, String[] id, String[] trip_destination, String[] trip_pickup_location, String[] trip_vehicle,
                                     ...
                                     String[] ac,String[] bid_accept_date,String[] bid_accept_time, String[] bid_rate_per_day,String[] bid_total_fare,String[] bids_on_trip,String[] bid_vehicle,
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            Trip_Button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent intent=new Intent(MyAcceptedBidsActivity.this,ClientTripDetailActivity.class);
            ...
            Bid_Button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    buttonClick.setDuration(175);
                    v.startAnimation(buttonClick);
                    Intent intent=new Intent(MyAcceptedBidsActivity.this,CompanyBidDetailActivity.class);
                    ...
                    intent.putExtra("bid_date_time","N/A");
                    intent.putExtra("my_bid_flag","0");
                    startActivity(intent);
    ...
    public void onBackPressed() {
        Intent intent=new Intent(MyAcceptedBidsActivity.this,MainActivity.class);
        startActivity(intent);
    }
